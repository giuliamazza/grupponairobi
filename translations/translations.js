window.translations = {
  en: {
    ...
    // Timeline Additions
    timeline_water: "Water Fountain",
    timeline_water_desc: "Clean water access for all students",
    ...
    timeline_ceilings: "Ceilings",
    timeline_ceilings_desc: "Next phase after foundations",
    timeline_classrooms: "6 Fully Furnished Classrooms",
    timeline_classrooms_desc: "Learning spaces for the children",
    timeline_completed: "Completed",
    timeline_completed_desc: "Final phase of the project",
  ...
  it: {
    ...
    timeline_ceilings: "Soffitti",
    timeline_ceilings_desc: "Prossima fase dopo le fondamenta",
    timeline_classrooms: "6 Aule Completamente Arredate",
    timeline_classrooms_desc: "Spazi di apprendimento per i bambini",
    timeline_completed: "Completato",
    timeline_completed_desc: "Fase finale del progetto",
  ...
  de: {
    ...
    timeline_ceilings: "Decken",
    timeline_ceilings_desc: "Nächste Phase nach den Fundamenten",
    timeline_classrooms: "6 Vollständig Ausgestattete Klassenzimmer",
    timeline_classrooms_desc: "Lernräume für die Kinder",
    timeline_completed: "Abgeschlossen",
    timeline_completed_desc: "Abschließende Projektphase",
